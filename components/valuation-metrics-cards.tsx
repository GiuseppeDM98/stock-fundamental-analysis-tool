  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-muted">{t("whatIsIt")}</p>
        <p className="text-sm text-white leading-relaxed">{metric.info.description}</p>

        <p className="mb-1 mt-5 text-xs font-semibold uppercase tracking-wider text-muted">{t("howToRead")}</p>
