...
- **Watchlist + daily email digest** — add tickers to a personal watchlist; each ticker is a compact card that expands into the same **valuation ruler** used on the saved-analyses page (buy/watch/rich zones, your fair value, the reviewer's fair value, consensus) with a Fair value ↔ Buy target toggle. A **daily** email digest breaks down Bear/Base/Bull by Analysis / Reviewer / Consensus alongside price and gap vs. your buy target. Pause emails with a single toggle when you're not actively investing. Each card shows a **price proximity badge** (distance from your buy target) and an inline **Analyze** action button.
